...
export default function MessengerBot() {
  ...
  const handleTestBot = async () => {
    ...
    try {
      ...
      setTestResponse("Processing your message...");
      
      // In a real implementation, this would call the AI service
      setTimeout(() => {
        setTestResponse(`AI Response: Thank you for your message "${testMessage}". This is a simulated response from the messenger bot. In the actual implementation, this would be generated by the selected AI model (${botSettings.aiModel}).`);
      }, 1000);
    } catch (error) {
      toast({
        title: "Test Failed",
        description: "Failed to test bot response.",
        variant: "destructive",
      });
    }
  };
            ...
            <CardContent className="space-y-4">
              ...
              {testResponse && (
                <div className="space-y-2">
                  ...
                  <div className="p-3 bg-muted rounded-lg" data-testid="div-bot-response">
